    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(icon: Icon(Icons.arrow_forward,), title: Text('小宝贝最漂亮惹'),backgroundColor: Colors.greenAccent ),
            BottomNavigationBarItem(icon: Icon(Icons.arrow_forward), title: Text('天天要开心鸭'),backgroundColor: Colors.limeAccent),
            BottomNavigationBarItem(icon: Icon(Icons.arrow_forward), title: Text('每天都要吃饱哦'),backgroundColor: Colors.cyanAccent),
            BottomNavigationBarItem(icon: Icon(Icons.favorite), title: Text('永远爱你！'),backgroundColor: Colors.pinkAccent),
